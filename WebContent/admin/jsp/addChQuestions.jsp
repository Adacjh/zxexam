...
<script type="text/javascript" src="../js/addChQuestions.js"></script>
...
<body>
	...
	<div id="main" role="main">
		<form id="submitform">
			...
			<!-- <input type="button" value="提交" name="tj" id="tj">
			<input type="text" name="xianshi" id="xianshi">  -->
			...
			<tr>
			<td>选项A:&nbsp;&nbsp;</td>
			<td align="center"><input type="checkbox" name="checkAnswer" value="A"/></td>
			<td><input placeholder="请输入选项A" type="text" class="text" name="checkAnswerA"/></td>
			</tr>
			<tr>
			<td>选项B:&nbsp;&nbsp;</td>
			<td align="center"><input type="checkbox" name="checkAnswer" value="B"/></td>
			<td><input placeholder="请输入选项B" type="text" class="text" name="checkAnswerB"/></td>
			</tr>
			<tr>
			<td>选项C:&nbsp;&nbsp;</td>
			<td align="center"><input type="checkbox" name="checkAnswer" value="C"/></td>
			<td><input placeholder="请输入选项C" type="text" class="text" name="checkAnswerC"/></td>
			</tr>
			<tr>
			<td>选项D:&nbsp;&nbsp;</td>
			<td align="center"><input type="checkbox" name="checkAnswer" value="D"/></td>
			<td><input placeholder="请输入选项D" type="text" class="text" name="checkAnswerD"/></td>
			</tr>
